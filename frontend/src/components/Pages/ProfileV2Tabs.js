    ...
    return (
      <div>
        ...
        <div className="tab-content padding-0">
          <div
            className={`tab-pane ${!tab ? "active show" : ""}`}
            id="Overview"
          >
            <div className="card">
              <div className="body">
          ...
          <div className={`tab-pane ${tab ? "active show" : ""}`} id="Settings">
            <div className="card">
              <div className="body">
                  ...
                  <div className="col-lg-12 col-md-12">
                    ...
                    <div className="form-group">
                      ...
                      <div className="fancy-radio">
                        <label>
                          <input name="dateFormat" value="" type="radio" />
                          <span>
                            <i></i>May 18, 2018
                          </span>
                        </label>
...
export default connect(mapStateToProps, {})(ProfileV2Tabs);
